  ...
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" :title="operate" width="500px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px" :disabled="operate==='详情'">
      <el-form-item label="数据权限标识符"  prop="permissionId">
        <el-input v-model="form.permissionId" style="width: 370px;"/>
      </el-form-item>
      <el-form-item label="字段代码"  prop="fieldCode">
        <el-input v-model="form.fieldCode" style="width: 370px;"/>
      </el-form-item>
      ...
      <el-form-item label="操作值"  prop="operateValue">
        <el-input v-model="form.operateValue" style="width: 370px;"/>
      </el-form-item>
    </el-form>
...
<script>
import { add, edit } from '@/api/dataPermissionField'
export default {
  props: {
    operate: {
      type: String,
